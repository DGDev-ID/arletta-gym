...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/master/personal-trainer-package/create' },
];
...
const submit = () => {
    form.post('/master/personal-trainer-package');
};
</script>
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <Head title="Tambah Personal Trainer Package" />

        <div class="min-h-screen bg-muted/40 py-10">
            <div class="max-w-3xl mx-auto px-6">
                <div class="rounded-2xl border bg-background shadow-sm p-8 space-y-8">

                    <Heading variant="small" title="Tambah Personal Trainer Package"
                        description="Tentukan paket personal trainer dan promo opsional." />
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input v-model="form.duration_in_sessions" type="number" placeholder="10" />
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-medium">Maksimal Peserta</label>
                            <Input v-model="form.max_person" type="number" placeholder="Isi 1 apabila individu / 2 apabila possible couple" />
                        </div>
                        ...
                        <div class="flex justify-end items-center gap-4 pt-6 border-t">
                            ...
                            <button type="submit" :disabled="form.processing"
                                ...
                                Simpan Personal Trainer Package
                            </button>
                        </div>
                    </form>
                </div>
