...
const form = useForm({
    ...
    promos: props.bundle_package.bundle_package_promos && props.bundle_package.bundle_package_promos.length > 0
        ? props.bundle_package.bundle_package_promos.map((p: any) => ({
