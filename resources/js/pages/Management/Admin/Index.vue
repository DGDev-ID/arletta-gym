        ...
        <div class="min-h-screen bg-muted/40 py-10">
            <div class="max-w-7xl mx-auto px-6 space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <Heading title="Management Admin"
                        description="Cari user untuk dijadikan admin dan kelola daftar admin aktif." />

                    <div class="relative w-full md:w-96">
                        <label class="text-xs font-medium mb-1.5 block text-muted-foreground italic">Cari email user
                            untuk ditambah jadi admin:</label>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y">
                            <tr v-for="admin in admins.data" :key="admin.id" class="hover:bg-muted/20 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <ul v-if="admin.gyms && admin.gyms.length > 0">
                                        <li v-for="gym in admin.gyms" :key="gym.id"
