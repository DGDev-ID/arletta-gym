...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:Super Admin|Admin'])->group(function () {
        Route::prefix('master')->name('master.')->group(function () {
            ...
            Route::post('product/{product}/reduce-stock', [MasterProductController::class, 'reduceStock'])->name('product.reduce-stock');
            Route::post('product/{product}/reset-stock', [MasterProductController::class, 'resetStock'])->name('product.reset-stock');
        ...
        Route::prefix('transaction')->name('transaction.')->group(function () {
            ...
            Route::delete('pos/{transactionProductOut}', [TransactionPosController::class, 'destroy'])->name('pos.destroy');
        });
